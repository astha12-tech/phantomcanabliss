...
List<BestSellingModel> bestsellingModelFromJson(String str) =>
    List<BestSellingModel>.from(
        json.decode(str).map((x) => BestSellingModel.fromJson(x)));

String bestSellingModelToJson(List<BestSellingModel> data) =>
