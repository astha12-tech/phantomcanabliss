...
//
//     final productsModel = categoryproductsModelFromJson(jsonString);

import 'dart:convert';

List<CategoryProductsModel> categoryproductsModelFromJson(String str) =>
    List<CategoryProductsModel>.from(
        json.decode(str).map((x) => CategoryProductsModel.fromJson(x)));

String productsModelToJson(List<CategoryProductsModel> data) =>
